...
class DataSource(private val httpClient: HttpClient) : IDataSource {
    override suspend fun getForecast(
        lat: Double,
        lon: Double
    ): Result<ForecastEntity, NetworkError> {
        val url = "https://api.open-meteo.com/v1/forecast?latitude=$lat&longitude=$lon&daily=weather_code,temperature_2m_min,temperature_2m_max,uv_index_max&hourly=temperature_2m,weather_code&current=temperature_2m,is_day,relative_humidity_2m,apparent_temperature,wind_speed_10m,rain,weather_code,pressure_msl&timezone=auto"
